...
public class OtpView extends AppCompatEditText {
    ...
    public OtpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        activeLineColor = typedArray.getColor(R.styleable.OtpView_activeLineColor, Color.WHITE);
        currentLineColor = typedArray.getColor(R.styleable.OtpView_currentLineColor, Color.WHITE);
        inactiveLineColor = typedArray.getColor(R.styleable.OtpView_inactiveLineColor, Color.WHITE);
